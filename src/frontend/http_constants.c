...
int POST_SIZE_LIMIT = 65536; // (N/A)                 How large of a POST body the server will accept and allocate a buffer for to be received
int HTTP_BUFFER_SIZE = 4096;
...
// Shared variables created in code

LinkedList* URL_ALIASES = NULL; // (aliases)     Converted to a set of URLs and file paths they map to